...
export default function Legal() {
  return (
    <div className="min-h-screen bg-wine-slate-950 text-stone-300 font-sans">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-wine-slate-950/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <Wine className="w-6 h-6 text-champagne-400" />
            <span className="font-serif font-semibold text-lg text-champagne-100 tracking-tight">Somm</span>
          </Link>
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-stone-400 hover:text-champagne-100 transition-colors text-sm font-medium"
          >
      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-serif font-bold text-champagne-100 mb-2">Legal Information</h1>
          <p className="text-stone-500 mb-12 font-light">Last updated: February 7, 2026</p>

          <div className="space-y-16">
            <section>
              <h2 className="text-2xl font-serif font-bold text-champagne-400 mb-6 pb-3 border-b border-white/10">
                Privacy Policy
              </h2>

              <div className="space-y-8 text-stone-300 font-light leading-relaxed">
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">1. Information We Collect</h3>
                  <p className="mb-3">
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">2. How We Use Your Information</h3>
                  <p className="mb-3">
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">3. Information Sharing</h3>
                  <p>
                    We do not sell, trade, or rent your personal information to third parties. We may share
                    your information only in the following circumstances:
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4 mt-3 text-stone-400">
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">4. Data Security</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">5. Your Rights</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">6. Cookies and Tracking</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">7. Age Requirements</h3>
                  <p>
            ...
            <section>
              ...
              <div className="space-y-8 text-stone-300 font-light leading-relaxed">
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">1. Acceptance of Terms</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">2. Use of Service</h3>
                  <p className="mb-3">
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">3. User Accounts</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">4. Recommendations Disclaimer</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">5. Responsible Drinking</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">6. Intellectual Property</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">7. Limitation of Liability</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">8. Modifications to Service</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">9. Termination</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">10. Changes to Terms</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">11. Governing Law</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-champagne-100 mb-3">12. Contact Information</h3>
                  <p>
      ...
      <footer className="py-8 px-6 border-t border-white/5 bg-black/20">
        <div className="max-w-6xl mx-auto text-center">
          <Link to="/" className="inline-flex items-center gap-2 text-stone-500 hover:text-champagne-100 transition-colors">
